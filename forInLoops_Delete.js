...
// Write a function called secrets that will take in an object. Create an empty string variable. Write a for in 
// loop that loops over the object. If the property name starts with an 'sh', 
// concatenate the value to the string variable. By the end of the for in loop, 
...
// Sometimes it's needed to delete object properties. All you need is the word delete before a reference to
//  the object property value. Uncomment the example below to see a for in loop deleting all the properties 
// inside an object.
...
// Write a function called removePassword that takes in an object. Delete the property password and return 
// the object.
...
// Write a function called startsWithK that takes an object as a parameter. Write a for in loop to loop 
// over the object. If any property name starts with k, delete that property. Return the updated object.
...
//  object. Each property will have a sentence as it's value. If the property value does not contain the 
// word 'treasure', delete the property. Return the updated object.
